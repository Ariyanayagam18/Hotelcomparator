                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-3">
                                                        <div class="text-right">
                                                            <img src="<?php echo e(asset('images/filter-search.svg')); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck9"><span class="ml-3 d-flex align-items-center">5<span class="ml-1 mr-2"><img src="<?php echo e(asset('images/Star.svg')); ?>"></span>Rating</span></label>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck10"><span class="ml-3 d-flex align-items-center">4<span class="ml-1 mr-2"><img src="<?php echo e(asset('images/Star.svg')); ?>"></span>Rating</span></label>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck11"><span class="ml-3 d-flex align-items-center">3<span class="ml-1 mr-2"><img src="<?php echo e(asset('images/Star.svg')); ?>"></span>Rating</span></label>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck12"><span class="ml-3 d-flex align-items-center">2<span class="ml-1 mr-2"><img src="<?php echo e(asset('images/Star.svg')); ?>"></span>Rating</span></label>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="customCheck13"><span class="ml-3 d-flex align-items-center">1<span class="ml-1 mr-2"><img src="<?php echo e(asset('images/Star.svg')); ?>"></span>Rating</span></label>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                            <div class="book-right">1</div>
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-12">
                                <div>
                                    <span class="select-multi">
                                        <div class="cross-red"><img src="<?php echo e(asset('images/red-cross.svg')); ?>"></div>
                        ...
                        <div class="list-wrapper">
                            <div class="row m-0  hotel-list list-item">
                                <div class="col-xl-5 col-lg-4 col-md-4 col-sm-4 col-12 p-0">
                                    <div class="hotel-img"><img src="<?php echo e(asset('images/room/room.svg')); ?>" class="w-100"></div>
                                </div>
                                <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-12 p-0">
                                    <div class="row m-0 pt-3">
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 w-sm-400">
                                            <div class="hotel-leftside">
                                                ...
                                                <div class="breakfast">
                                                    <img src="<?php echo e(asset('images/break.svg')); ?>">
                                    ...
                                    <div class="row m-0 pb-3">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 pr-0 w-sm-400">
                                            <div class="exp-price">                                              
                                                <div><img src="<?php echo e(asset('images/exp-img.svg')); ?>"></div>   
                            ...
                            <div class="row m-0  hotel-list list-item">
                                <div class="col-xl-5 col-lg-4 col-md-4 col-sm-4 col-12 p-0">
                                    <div class="hotel-img"><img src="<?php echo e(asset('images/room/room1.svg')); ?>" class="w-100"></div>
                                </div>
                                <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-12 p-0">
                                    <div class="row m-0 pt-3">
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 w-sm-400">
                            ...
                            <div class="row m-0  hotel-list list-item">
                                <div class="col-xl-5 col-lg-4 col-md-4 col-sm-4 col-12 p-0">
                                    <div class="hotel-img"><img src="<?php echo e(asset('images/room/room2.svg')); ?>" class="w-100"></div>
                                </div>
                                <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-12 p-0">
                                    <div class="row m-0 pt-3">
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 w-sm-400">
                            ...
                            <div class="row m-0  hotel-list list-item">
                                <div class="col-xl-5 col-lg-4 col-md-4 col-sm-4 col-12 p-0">
                                    <div class="hotel-img"><img src="<?php echo e(asset('images/room/room3.svg')); ?>" class="w-100"></div>
                                </div>
                                <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-12 p-0">
                                    <div class="row m-0 pt-3">
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 w-sm-400">
                            ...
                            <div class="row m-0  hotel-list list-item">
                                <div class="col-xl-5 col-lg-4 col-md-4 col-sm-4 col-12 p-0">
                                    <div class="hotel-img"><img src="<?php echo e(asset('images/room/room4.svg')); ?>" class="w-100"></div>
                                </div>
                                <div class="col-xl-7 col-lg-8 col-md-8 col-sm-8 col-12 p-0">
                                    <div class="row m-0 pt-3">
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-7 w-sm-400">
...
<?php /**PATH /opt/lampp/htdocs/Projects/Hotel Comparator/Hotel_latest/resources/views/pages/afterlogin.blade.php ENDPATH**/ ?>